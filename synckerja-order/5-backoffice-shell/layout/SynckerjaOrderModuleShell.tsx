...
import { SynckerjaOrderHeaderAndTab } from "./SynckerjaOrderHeaderAndTab";
import { SynckerjaOrderPageSkeleton } from "../pages/SynckerjaOrderPageSkeleton";
import { SYNCKERJA_ORDER_BASE_PATH } from "../lib/synckerjaOrderTabs";
...
export function SynckerjaOrderModuleShell({
  children,
  showContent,
  loadingSkeleton,
  businessName,
  ...
  const skeleton = loadingSkeleton ?? <SynckerjaOrderPageSkeleton />;
  return (
          ...
          <div className="flex h-full min-h-0 w-full min-w-0 flex-col">
            <div className={cn(MAIN_SCROLL, "min-w-0")}>
              <div className="flex min-h-full min-w-0 flex-col bg-muted/40">
                ...
                <ModuleShellContentGate pagePath={SYNCKERJA_ORDER_BASE_PATH}>{children}</ModuleShellContentGate>
              </div>
            </div>
          </div>
        </div>
