-- Canonical Live Chat URL: `/omnichannel/livechat` (replaces `/operations/consultant/all/livechat`).
...
SET page_path = '/omnichannel/livechat'
WHERE page_path = '/operations/consultant/all/livechat';
...
WHERE d.page_path = '/omnichannel/livechat'
  AND NOT EXISTS (
    SELECT 1
