-- Recipient picker: lead_submissions profile CTE (submitted then draft).
﻿-- Re-apply search_whatsapp_recipient_picker: livechat status/assignee/FU filters, survey_rating sort, surveyRating none.
-- Safe if 20260519120000 already applied (idempotent CREATE OR REPLACE).
