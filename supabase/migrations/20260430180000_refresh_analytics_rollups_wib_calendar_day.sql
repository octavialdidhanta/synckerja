-- Agregat harian: sebelumnya memakai tanggal kalender **UTC** pada started_at/created_at.
-- UI & filter memakai tanggal **Jakarta (WIB)**. Akibatnya, mis. "30 Apr 2026" di UI
-- (20 sesion di WIB) tidak bertemu baris `day = 2026-04-30` bila di UTC semua jatuh ke 2026-04-29.
-- Rollup: bucket `day` = (timezone('Asia/Jakarta', ts))::date untuk semua event time.
