-- Canonical Leads Management URL: `/omnichannel/leads` (replaces `/operations/consultant/leads-management`).
...
SET page_path = '/omnichannel/leads'
WHERE page_path = '/operations/consultant/leads-management';
...
WHERE d.page_path = '/omnichannel/leads'
  AND NOT EXISTS (
    SELECT 1
