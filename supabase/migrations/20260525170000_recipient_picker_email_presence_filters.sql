-- Recipient picker: display_email from lead_submissions + toolbar gclidPresence/emailPresence filters.

-- Re-apply search_whatsapp_recipient_picker (full function from 20260525160000 + email/presence).
