-- End shift with cashier-counted closing cash (reconciliation).
-- expected_cash = system formula; closing_cash = physical count.

DROP FUNCTION IF EXISTS public.pos_end_shift(uuid);
