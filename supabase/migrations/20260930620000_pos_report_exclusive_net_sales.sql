-- Moka-style reporting: Net Sales exclusive of tax/gratuity; Total Collected = Net + Tax + Gratuity + Rounding

CREATE OR REPLACE FUNCTION public.pos_sales_activity_exclusive_net(
  p_subtotal numeric,
  p_tax numeric,
  p_gratuity numeric,
  p_paid numeric,
...
COMMENT ON FUNCTION public.pos_sales_activity_exclusive_net(numeric, numeric, numeric, numeric, text) IS
  'Report net sales (Moka-style): exclusive of tax/gratuity when checkout is tax-inclusive.';
