-- Recipient picker: include leads.gclid in search_whatsapp_recipient_picker JSON (parity with /omnichannel/leads).
-- Re-applies full function (one row per lead, lead_submissions profile, filters, survey sort).
-- Apply after 20260525143000 if that migration was already deployed without gclid.
