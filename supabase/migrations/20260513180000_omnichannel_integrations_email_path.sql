-- Canonical Connect Email URL: `/omnichannel/integrations/email` (replaces `/operations/consultant/email/connect`).
...
SET page_path = '/omnichannel/integrations/email'
WHERE page_path = '/operations/consultant/email/connect';
...
WHERE d.page_path = '/omnichannel/integrations/email'
  AND NOT EXISTS (
    SELECT 1
