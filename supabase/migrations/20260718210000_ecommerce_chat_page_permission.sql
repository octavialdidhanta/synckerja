-- Page permission: Operations — E-Commerce Chat (Shopee / TikTok Shop / Blibli inbox)
...
VALUES (
  '/operations/sales/ecommerce-chat',
  'Operations — Sales — E-Commerce Chat',
  true,
...
WHERE d.page_path = '/operations/sales/ecommerce-chat'
  AND NOT EXISTS (
    SELECT 1
