-- Hotfix: PostgREST 400 / Postgres 42703 at runtime — lead_base referenced
-- public.leads.lead_phone_raw (column does not exist). Use l.phone_number in raw_phone coalesce.
-- Idempotent: replaces search_whatsapp_recipient_picker body only.
