-- Canonical WhatsApp Recipient Lists URL: `/omnichannel/campaign/recipient-lists` (replaces `/operations/campaign/recipient-lists`).
...
SET page_path = '/omnichannel/campaign/recipient-lists'
WHERE page_path = '/operations/campaign/recipient-lists';
...
WHERE d.page_path = '/omnichannel/campaign/recipient-lists'
  AND NOT EXISTS (
    SELECT 1
