-- When subscription_end_date and payment-derived v_end_ts are both NULL (e.g. trial),
-- v_scheduled_date became NULL and clients inserted NULL into subscription_change_requests.scheduled_date (NOT NULL) → 400.
