-- Move Xendit from /incomes/xendit to top-level /xendit (Finance sub-sidebar module).

UPDATE public.permission_configuration_defaults
SET
  page_path = '/xendit',
  page_title = 'Xendit Banking',
  updated_at = now()
WHERE page_path = '/incomes/xendit';
