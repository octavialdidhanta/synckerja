...
/** @deprecated Use social-media-scheduler. Kept for backward compatibility during cron migration. */
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    return scheduledPostsJson({ ...result, deprecated: "use social-media-scheduler" }, 200);
  } catch (e) {
    const message = e instanceof Error ? e.message : "scheduler_failed";
    console.error("tiktok-content-scheduler (shim):", message);
