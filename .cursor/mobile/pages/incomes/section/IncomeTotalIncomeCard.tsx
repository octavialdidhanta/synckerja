...
interface IncomeTotalIncomeCardProps {
  totalIncome: number;
  totalIncomeMonthToDate: number;
}

export function IncomeTotalIncomeCard({
  totalIncome,
  totalIncomeMonthToDate,
}: IncomeTotalIncomeCardProps) {
      ...
      <CardContent className="p-3 min-w-0 flex flex-col gap-3">
        ...
        <div className="flex items-center justify-between gap-3 min-w-0">
          <div className="min-w-0 flex-1">
            <div className="text-2xl sm:text-3xl font-bold text-white truncate">{formatToRupiah(totalIncomeMonthToDate)}</div>
