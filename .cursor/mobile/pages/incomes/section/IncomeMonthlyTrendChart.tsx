...
interface IncomeMonthlyTrendChartProps {
  monthlyData: MonthlyIncomeItem[];
  isEmpty?: boolean;
}

const CHART_MIN_WIDTH = 680;

export function IncomeMonthlyTrendChart({ monthlyData, isEmpty }: IncomeMonthlyTrendChartProps) {
