...
import { PaymentReadyToPayCard } from "@/mobile/pages/expenses/payment/section/PaymentReadyToPayCard";
import { PaymentPendingPaymentCard } from "@/mobile/pages/expenses/payment/section/PaymentPendingPaymentCard";
import { PaymentPaidCard } from "@/mobile/pages/expenses/payment/section/PaymentPaidCard";
import { PaymentProcessingCard } from "@/mobile/pages/expenses/payment/section/PaymentProcessingCard";
...
interface PaymentDashboardCarouselProps {
  isLoading: boolean;
  readyToPay: number;
    ...
    <div className="w-full overflow-hidden">
      ...
      >
        <div className="flex-shrink-0 px-2" style={{ width: `${slideWidthPercent}%` }}>
          <PaymentProcessingCard processing={processing} />
        </div>
        <div className="flex-shrink-0 px-2" style={{ width: `${slideWidthPercent}%` }}>
          <PaymentReadyToPayCard readyToPay={readyToPay} />
        </div>
        <div className="flex-shrink-0 px-2" style={{ width: `${slideWidthPercent}%` }}>
          <PaymentPendingPaymentCard pendingPayment={pendingPayment} />
        </div>
        <div className="flex-shrink-0 px-2" style={{ width: `${slideWidthPercent}%` }}>
          <PaymentPaidCard paid={paid} />
        </div>
        <div className="flex-shrink-0 px-2" style={{ width: `${slideWidthPercent}%` }}>
          <PaymentProcessingCard processing={processing} />
        </div>
