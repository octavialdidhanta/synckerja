...
import { ApprovalsTotalRequestsCard } from "@/mobile/pages/expenses/approvals/section/ApprovalsTotalRequestsCard";
import { ApprovalsPendingReviewCard } from "@/mobile/pages/expenses/approvals/section/ApprovalsPendingReviewCard";
import { ApprovalsApprovedCard } from "@/mobile/pages/expenses/approvals/section/ApprovalsApprovedCard";
import { ApprovalsRecurringCard } from "@/mobile/pages/expenses/approvals/section/ApprovalsRecurringCard";
...
interface ApprovalsDashboardCarouselProps {
  isLoading: boolean;
    ...
    <div className="w-full overflow-hidden">
      ...
      >
        <div className="flex-shrink-0 px-2" style={{ width: `${slideWidthPercent}%` }}>
          <ApprovalsRecurringCard recurring={recurring} />
        </div>
        <div className="flex-shrink-0 px-2" style={{ width: `${slideWidthPercent}%` }}>
          <ApprovalsTotalRequestsCard totalRequests={totalRequests} />
        </div>
        <div className="flex-shrink-0 px-2" style={{ width: `${slideWidthPercent}%` }}>
          <ApprovalsPendingReviewCard pendingReview={pendingReview} />
        </div>
        <div className="flex-shrink-0 px-2" style={{ width: `${slideWidthPercent}%` }}>
          <ApprovalsApprovedCard approved={approved} />
        </div>
        <div className="flex-shrink-0 px-2" style={{ width: `${slideWidthPercent}%` }}>
          <ApprovalsRecurringCard recurring={recurring} />
        </div>
