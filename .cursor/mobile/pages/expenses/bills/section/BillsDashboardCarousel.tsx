...
import { BillsTotalRecurringBillsCard } from "./BillsTotalRecurringBillsCard";
import { BillsDueThisWeekCard } from "./BillsDueThisWeekCard";
import { BillsOverdueCard } from "./BillsOverdueCard";
import { BillsCompletedCard } from "./BillsCompletedCard";
...
interface BillsDashboardCarouselProps {
  isLoading: boolean;
    ...
    <div className="w-full overflow-hidden">
      ...
      >
        <div className="flex-shrink-0 px-2" style={{ width: `${slideWidthPercent}%` }}>
          <BillsCompletedCard completed={completed} />
        </div>
        <div className="flex-shrink-0 px-2" style={{ width: `${slideWidthPercent}%` }}>
          <BillsTotalRecurringBillsCard totalRecurringBills={totalRecurringBills} />
        </div>
        <div className="flex-shrink-0 px-2" style={{ width: `${slideWidthPercent}%` }}>
          <BillsDueThisWeekCard dueThisWeek={dueThisWeek} />
        </div>
        <div className="flex-shrink-0 px-2" style={{ width: `${slideWidthPercent}%` }}>
          <BillsOverdueCard overdue={overdue} />
        </div>
        <div className="flex-shrink-0 px-2" style={{ width: `${slideWidthPercent}%` }}>
          <BillsCompletedCard completed={completed} />
        </div>
