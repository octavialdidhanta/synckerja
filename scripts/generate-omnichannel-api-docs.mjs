#!/usr/bin/env node
/**
 * Generate API_ACCESSIBILITY_DOCS.md from openapi.yaml (Bahasa Indonesia).
 * Usage: node scripts/generate-omnichannel-api-docs.mjs
 */
...
const openApiPath = path.join(root, "supabase/functions/omnichannel-public-api/openapi.yaml");
const outPath = path.join(root, "API_ACCESSIBILITY_DOCS.md");
...
const sdkSnippet = `(function (window, document) {
  'use strict';
...
const md = `# Panduan Integrasi API Omnichannel

> v**${version}** · \`npm run generate:omnichannel-api-docs\`
