# Prompt for AI → PDF (Google Ads API Design Document)

Copy **everything inside the blockquote below** (from "You are generating…" through "End of document") into your AI prompt-to-PDF tool.

---

> You are generating a **complete, submission-ready PDF design document** for Google Ads API Basic Access (Question 7) and OAuth scope verification. **Do NOT summarize, shorten, or omit any section.** Target length: **10–15 pages**. Use professional formatting: cover metadata table, numbered sections 1–12, tables where specified, monospace for code/paths, and a full Appendix.
>
> **Title:** Synckerja – Google Ads API Integration  
> **Subtitle:** Design Documentation (Google Ads API Basic Access – Question 7 · OAuth scope justification)
>
> ---
>
...
>
> Organization administrators connect Google Ads via OAuth **only when they choose "Connect Google Ads"** in settings. Settings are available at:
> - `/omnichannel/settings/google-ads`
> - `/digital-marketing/google-ads/settings` (same configuration UI inside Digital Marketing)
>
> The connecting Google account must already have access to the target Google Ads customer IDs.
>
...
> | Who connects Google Ads | Organization administrators via settings paths above |
...
>
> **Flow diagram (render as text diagram):**
>
> ```
> [Org admin] → Connect Google Ads (settings)
...
> | APP_PUBLIC_URL | App origin for post-OAuth redirect (https://office.synckerja.com) |
...
> | Password | (provided separately in Google application form — not in this document) |
> | Organization | Test |
> | Role | owner |
>
...
> 2. Open **Omnichannel → Settings → Google Ads** (`/omnichannel/settings/google-ads`) OR **Digital Marketing → Google Ads → Settings** (`/digital-marketing/google-ads/settings`).
...
> **Redirect URI:** https://wqdzqqshoifwyrltzgvx.supabase.co/functions/v1/google-ads-oauth-callback
>
> ### 3) Demo video
>
...
> ---
>
> **Formatting rules for PDF output:**
> - Include ALL 12 sections plus Appendix (do not merge or skip sections 9–12).
> - Keep all tables intact.
> - Do not add marketing fluff or change technical facts.
> - Page footer: "Synckerja – Google Ads API Design Document – May 2026"
