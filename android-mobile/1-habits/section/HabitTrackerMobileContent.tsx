...
export const HabitTrackerMobileContent = () => {
  ...
  if (showInitialLoading) {
    return (
      <div
        ref={listScrollRef}
        className="scrollbar-hide flex-1 overflow-y-auto overflow-x-hidden seamless-scroll nested-scroll-touch-chain min-h-0 flex flex-col [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
      >
