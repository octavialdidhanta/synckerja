...
type TikTokAdsMobileShellHeaderProps = {
  onRefresh?: () => void;
...
export function TikTokAdsMobileShellHeader({
  onRefresh,
  refreshDisabled,
  isRefreshing,
  headerActions,
}: TikTokAdsMobileShellHeaderProps) {
        ...
        <div className="flex min-w-0 flex-1 items-center gap-2">
          ...
          <div className="min-w-0">
            <h1 className="truncate text-base font-semibold leading-tight text-foreground">
              {t("sidebar.digitalMarketing.tiktokAds.title", "TikTok Ads")}
            </h1>
          </div>
        </div>
