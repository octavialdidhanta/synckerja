      ...
      <div className="rounded-lg border border-primary/20 bg-primary/5 p-4">
        <div className="mb-3 flex items-center gap-2">
          ...
          <h4 className="text-sm font-semibold text-foreground">
            {t('initiative.stats.title', 'Available tasks')}
          </h4>
        </div>
        <div className="space-y-2">
          <div className="flex justify-between text-sm">
            <span className="text-muted-foreground">{t('initiative.stats.totalAvailable', 'Total available')}</span>
            <span className="font-medium text-foreground">{uncompletedItems.length}</span>
          </div>
          <div className="flex justify-between text-sm">
            <span className="text-muted-foreground">{t('initiative.stats.unassigned', 'Unassigned')}</span>
      ...
      <div className="space-y-1">
        {uncompletedItems.length === 0 ? (
          <div className="py-8 text-center text-muted-foreground">
            <CheckCircle className="mx-auto mb-3 h-12 w-12 text-primary/30" aria-hidden />
            <p className="text-sm font-medium text-foreground">{t('initiative.empty.allDone', 'All tasks completed!')}</p>
            <p className="mt-1 text-xs">{t('initiative.empty.greatJob', 'Great job, nothing left to do.')}</p>
          </div>
        ) : (
            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div className="flex-1 min-w-0">
                  ...
                  {/* Title */}
                  <h5 className="mb-1 line-clamp-2 text-sm font-semibold text-foreground">
                    {item.title}
                  </h5>
