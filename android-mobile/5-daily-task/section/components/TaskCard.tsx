...
import type { Task, TaskStep as TaskStepEntity } from '@/8-2-DailyTask/types';
...
/** Minimum deliberate leftward movement (px) before a release can snap the strip open */
const MIN_SWIPE_MOVEMENT = 32;
...
export const TaskCard: React.FC<TaskCardProps> = ({
  ...
  const handleTouchEnd = (e: React.TouchEvent) => {
    ...
    let openedBySwipe =
      start.didSwipe === true && current < -SWIPE_THRESHOLD && !closedBySwipe;
