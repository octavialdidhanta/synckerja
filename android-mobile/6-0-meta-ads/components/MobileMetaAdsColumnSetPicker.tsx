...
import { MetaAdsColumnSetOptionLabel } from "@/meta-ads/components/MetaAdsColumnSetOptionLabel";
...
export function MobileMetaAdsColumnSetPicker({
  columnSets,
  activeId,
  onSelect,
  disabled,
  ...
  const columnSetLabel = t("digitalMarketing.metaAds.activeColumnSet", "Column set");
