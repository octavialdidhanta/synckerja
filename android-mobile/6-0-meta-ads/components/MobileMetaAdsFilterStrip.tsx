...
export function MobileMetaAdsFilterStrip({
  ...
  const activeAccount = useMemo(
    () => accounts.find((a) => a.ad_account_id === adAccountId) ?? null,
      ...
      >
        <div className="inline-flex items-center gap-2 py-2">
          ...
          <Button
            ...
            aria-label={t("digitalMarketing.metaAds.adAccount", "Ad account")}
          >
          ...
          <div className="min-w-[11rem] max-w-[16rem] shrink-0">
            <MobileTrafficDateRangeDrawer
              ...
              fieldLabel={t("digitalMarketing.metaAds.dateRangeLabel", "Date range")}
        ...
        <DrawerContent className="max-h-[85vh] px-0 pb-4">
          ...
          <div className="max-h-[min(60vh,360px)] overflow-y-auto px-2">
            {accounts.length === 0 ? (
              ...
              accounts.map((a) => {
                const label = a.label?.trim() || a.ad_account_id;
                const isActive = a.ad_account_id === adAccountId;
                return (
                  <button
                    key={a.id}
                    type="button"
                    className={cn(
                      ...
                      !a.metricsReady && "opacity-70",
                    )}
                    onClick={() => {
                      onAdAccountIdChange(a.ad_account_id);
