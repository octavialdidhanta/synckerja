...
import { formatAttendanceTimeShort } from "@/mobile-app/utils/postgresAttendanceTime";
    ...
    <Card className="bg-gradient-card border border-border">
      ...
      <div className="p-3">
        <div className="w-full overflow-x-auto">
          ...
          <div className="h-48 overflow-y-auto overflow-x-hidden scrollbar-hide seamless-scroll [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
              ...
              {loading ? (
                ...
                return <div key={record.id} className="flex text-xs border-b border-border/50 last:border-b-0 items-center gap-2 py-0">
                    ...
                    flexBasis: '12%'
                        ...
                        <div className="flex-shrink-0 text-foreground truncate" style={{
                    flexBasis: '10%'
                  }} title={formatAttendanceTimeShort(record.check_in_time)}>
                          {formatAttendanceTimeShort(record.check_in_time)}
                        </div>
                        <div className="flex-shrink-0 text-foreground truncate" style={{
                    flexBasis: '10%'
                  }} title={formatAttendanceTimeShort(record.check_out_time)}>
                          {formatAttendanceTimeShort(record.check_out_time)}
                        </div>
