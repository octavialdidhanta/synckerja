...
export function MobileClickDetailsDialog({
  ...
  const bodyContent = !queryDateReady ? (
    <div className="rounded-xl border bg-card p-4 text-center text-sm text-muted-foreground">Loading…</div>
    ...
    <div className="rounded-xl border bg-card p-4 text-center text-sm text-muted-foreground">Tidak ada data.</div>
  ) : (
    <div className="rounded-xl border bg-card" data-horizontal-scroll-zone>
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <div className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden seamless-scroll">
          <div className="mx-auto w-full max-w-md px-2 pb-4 pt-2">{bodyContent}</div>
        </div>
