...
import type { WorkSchedule, ScheduleDay } from "@/mobile/1-schedule/hooks/useWorkSchedule";
  ...
  return (
    <div className="bg-card rounded-lg border border-border overflow-hidden">
      ...
      <div className="overflow-hidden">
        ...
        {/* Schedule Items */}
        <div className="max-h-64 overflow-y-auto overflow-x-hidden scrollbar-hide seamless-scroll [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
