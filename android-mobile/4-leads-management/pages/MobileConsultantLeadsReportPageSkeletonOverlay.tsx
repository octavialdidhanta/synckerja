import { FileBarChart, MessageCircle, UserPlus } from "lucide-react";
...
/**
 * Mirror struktur `LeadsManagementPage` → `main` + `LeadsReportSummaryView` (mobile) + `NavigationFooter` hideItems (3 kolom).
...
function LeadsReportInsightsSkeletonBody() {
  ...
  return (
    <div className="min-w-0 max-w-full space-y-1 mt-1">
    ...
    >
      ...
      >
        ...
        <nav className="mobile-app-bottom-nav fixed bottom-0 left-0 right-0 z-30 border-t border-border bg-card safe-area-bottom-lower">
          <div className={cn("mx-auto grid max-w-md min-h-[52px] grid-cols-3")}>
