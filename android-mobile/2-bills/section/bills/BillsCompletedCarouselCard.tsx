...
interface BillsCompletedCarouselCardProps {
  count: number;
  amount: number;
}

export function BillsCompletedCarouselCard({ count, amount }: BillsCompletedCarouselCardProps) {
      ...
      <CardContent className="flex min-w-0 flex-col gap-3 p-3">
        <div className="flex items-center gap-2">
          ...
          <span className="truncate text-sm font-medium text-white/90">
            {t("reminderBills.metrics.completed", "Completed")}
          </span>
        </div>
