  ...
  return (
    <div className="rounded-lg border-2 border-border bg-card p-3 shadow-sm">
      <div className="flex items-start justify-between gap-2">
        <div>
          <p className="font-semibold text-sm text-foreground">{summary.name}</p>
          {summary.jobTitle && (
            <p className="text-xs text-muted-foreground">{summary.jobTitle}</p>
          )}
      ...
      <div className="flex items-center gap-4 mt-3 flex-wrap">
        ...
        <div>
          <p className="text-xs font-semibold text-foreground">{completedAssignments.length}</p>
          ...
          {assignmentsToShow.map((assignment) => {
            ...
            return (
              <div
                ...
                className="rounded-md border-2 border-border p-2 text-xs"
              >
                <div className="flex items-start justify-between gap-2">
                  <div>
                    ...
                    {extraLabel && (
                      <p 
                        className="text-[11px] text-muted-foreground line-clamp-1 cursor-pointer hover:text-primary transition-colors"
                        onClick={() => handleTaskTitleClick(assignment)}
                        title="Click to search and view this task"
                      >
                        {extraLabel}
                    ...
                    {assignment.rejectReason && (
                      <div className="mt-1.5 p-2 bg-amber-50 border border-amber-200 rounded text-[11px]">
                        ...
                        <p className="text-foreground mt-0.5">{assignment.rejectReason}</p>
                      </div>
                    )}
              ...
              {completedAssignments.map((assignment) => {
                ...
                return (
                  <div
                    ...
                    className="rounded-md border-2 border-emerald-200 bg-emerald-50 p-2 text-xs"
                  >
                    <div className="flex items-start justify-between gap-2">
                      <div>
                        <div className="flex flex-wrap items-center gap-2">
