...
import {
  ...
  CardHeader,
  CardTitle,
} from "@/mobile-app/components/ui/card";
import { Badge } from "@/mobile-app/components/ui/badge";
import { Slider } from "@/mobile-app/components/ui/slider";
      ...
      >
        ...
        <CardContent className="space-y-4 pb-5">
          ...
          <div className="rounded-xl border border-border bg-card/60 p-4">
            ...
            <div className="scrollbar-hide seamless-scroll nested-scroll-touch-chain mt-3 max-h-40 space-y-2 overflow-y-auto pr-1 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
...
const HRISSubscriptionPlansTab = ({ refetchRef }: HRISSubscriptionPlansTabProps) => {
  ...
  const { data: plans, error, refetch: refetchPlans } = useSubscriptionPlans();
