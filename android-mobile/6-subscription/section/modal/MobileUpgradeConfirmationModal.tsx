import { Dialog, DialogContent, DialogHeader, DialogTitle, DialogDescription } from "@/mobile-app/components/ui/dialog";
...
import type { SubscriptionPlan, SubscriptionStatus } from "@/10-subscription/hooks/useOptimizedSubscription";
