...
const PlansTabPage = memo(() => {
  ...
  return (
    <MobileSubscriptionPageShell
      pagePath={MOBILE_PAGE_PATH.subscriptionPlans}
      headerVariant="plans"
      activeTab={activeTab}
      onTabChange={handleTabChange}
      mainFixedStyle={mainFixedStyle}
      mainClassName="max-w-none min-w-0"
      showPageSkeleton={showPageSkeleton}
      skeletonOverlay={showPageSkeleton ? <MobileSubscriptionPlansPageSkeletonOverlay /> : null}
    >
      <div
        ref={listScrollRef}
