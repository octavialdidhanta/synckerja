...
function VisitSchedulingHeaderAndTabSkeleton() {
  return (
...
/** Mirrors `VisitSchedulingFilters` row (search + combobox + 2 selects + icon + primary). */
function VisitSchedulingFiltersSkeleton() {
  return (
...
function VisitSchedulingMetricsSkeleton() {
  return (
...
function VisitSchedulingTableSkeleton() {
  return (
...
function VisitSchedulingOverviewSidebarSkeleton() {
  return (
...
/**
 * Mirrors `/operations/sales/jadwal-kunjungan`: `SalesOperationsSeamlessSubpageLayout` + `VisitSchedulingPageContent`.
 * Same inner 9+3 / metrics / table / sidebar rhythm as `/operations/sales/activities` (SalesActivitiesPageSkeleton).
 */
export function VisitSchedulingPageSkeleton() {
  return (
          ...
          <div className="scrollbar-hide seamless-scroll nested-scroll-touch-chain flex h-full min-h-0 w-full min-w-0 max-w-full flex-1 overflow-x-hidden overflow-y-auto [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
            <div className="flex min-h-full w-full min-w-0 max-w-full flex-col">
              <div className="mb-1 w-full min-w-0 max-w-full shrink-0">
                <VisitSchedulingHeaderAndTabSkeleton />
              </div>
                      ...
                      <div className="flex h-full min-h-0 min-w-0 w-full max-w-full flex-col">
                        <div className="mb-2 flex-shrink-0">
                          <div className="rounded-md border border-gray-200 bg-white p-2">
                            <VisitSchedulingFiltersSkeleton />
                          </div>
                        </div>
                        <div className="mb-2 flex-shrink-0">
                          <VisitSchedulingMetricsSkeleton />
                        </div>
                      ...
                      <div className="flex h-full min-h-0 min-w-0 w-full max-w-full flex-col">
                        <div className="flex h-full min-h-0 min-w-0 w-full max-w-full flex-col rounded-lg border border-gray-200 bg-white shadow-sm">
                          ...
                          <div className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden seamless-scroll nested-scroll-touch-chain p-4">
                            <VisitSchedulingOverviewSidebarSkeleton />
                          </div>
