...
import { ModalAddDepartmentContribution } from '@/1-home/components/HomeOKRDashboard/modal/ModalAddDepartmentContribution';
        ...
        <div className="border-b border-border p-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <Building className="mr-2 h-5 w-5 text-okr-department" />
        ...
        <div className="p-3">
          {loading ? (
            ...
            <div className="space-y-2">
              ...
              <div className="h-2 w-full rounded-full bg-muted">
                <div
                  className="h-2 rounded-full bg-okr-department transition-all duration-500"
