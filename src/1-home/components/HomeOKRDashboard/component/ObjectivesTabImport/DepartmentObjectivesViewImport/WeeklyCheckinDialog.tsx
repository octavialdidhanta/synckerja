...
export const WeeklyCheckinDialog: React.FC<WeeklyCheckinDialogProps> = ({
  ...
  const getStatusColor = (status: CheckinStatus) => {
    switch (status) {
      case 'on_track': return 'bg-success-muted text-success-foreground';
      case 'at_risk': return 'bg-warning-muted text-warning-foreground';
      case 'off_track': return 'bg-destructive/10 text-destructive';
