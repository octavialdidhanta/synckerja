...
import { EmployeesStaffPageSkeleton } from "../pages/EmployeesStaffPageSkeleton";

type EmployeesStaffModuleShellProps = {
  children: ReactNode;
  showContent: boolean;
...
export function EmployeesStaffModuleShell({
  children,
  showContent,
  loadingSkeleton,
}: EmployeesStaffModuleShellProps) {
  const skeleton = loadingSkeleton ?? <EmployeesStaffPageSkeleton />;
  return (
