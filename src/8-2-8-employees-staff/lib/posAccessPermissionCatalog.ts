...
export const POS_BACKOFFICE_PERMISSION_TREE: PosPermissionNode[] = [
  ...
  {
    key: "bo.synckerja_order",
    labelKey: "employeesStaff.perm.bo.synckerjaOrder",
    labelFallback: "Synckerja Order",
  },
  {
    key: "bo.dashboard",
...
export const POS_BACKOFFICE_NAV_PERMISSION: Record<string, string> = {
  ...
  "/operations/synckerja-order": "bo.synckerja_order",
...
export const POS_BACKOFFICE_PATH_PERMISSION: Array<{ prefix: string; key: string }> = [
  ...
  { prefix: "/operations/synckerja-order", key: "bo.synckerja_order" },
