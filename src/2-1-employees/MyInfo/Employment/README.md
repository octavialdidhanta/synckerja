# Employment Information Page Components

This directory contains ALL components, hooks, utilities, and types for the `/my-info/employment?id={id}` page functionality.
...
│   └── EmployeeEmploymentInfo.tsx # /my-info/employment?id={id} page
...
- **Employment Information Management**: View and edit employee employment details
...
```tsx
import { EmployeeEmploymentInfo } from '@/components/1_halaman/2_1_employee/MyInfo/Employment';

// Use in routing
<Route path="/my-info/employment" element={<EmployeeEmploymentInfo />} />

// Import specific components
import { EmploymentInfoTab, EmployeePageLayout } from '@/components/1_halaman/2_1_employee/MyInfo/Employment';

// Import hooks
import { useEmployeeDetail, useUpdateEmployee } from '@/components/1_halaman/2_1_employee/MyInfo/Employment';
```
...
### Pages:
- `src/pages/EmployeeEmploymentInfo.tsx`
