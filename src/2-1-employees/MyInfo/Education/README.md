# Education Information Page Components

This directory contains ALL components, hooks, utilities, and types for the `/my-info/education/formal?id={id}` page functionality.
...
│   ├── EmployeeEducationFormal.tsx # /my-info/education/formal?id={id} page
│   └── EmployeeEducation.tsx       # Redirect to formal education
...
│       ├── EducationInfoTab.tsx   # ⭐ Main: Education information tab
...
- **Formal Education Management**: View and edit employee formal education records
...
```tsx
import { EmployeeEducationFormal } from '@/components/1_halaman/2_1_employee/MyInfo/Education';

// Use in routing
<Route path="/my-info/education/formal" element={<EmployeeEducationFormal />} />

// Import specific components
import { EducationInfoTab, EmployeePageLayout } from '@/components/1_halaman/2_1_employee/MyInfo/Education';

// Import hooks
import { useEducations, useEmployeeDetail } from '@/components/1_halaman/2_1_employee/MyInfo/Education';
```
...
### Pages:
- `src/pages/EmployeeEducationFormal.tsx`
- `src/pages/EmployeeEducation.tsx`
...
- `useUpdateEmployee` - Update employee data
- `useAutoSave` - Auto-save education changes
- `useEducations` - CRUD operations for formal education
