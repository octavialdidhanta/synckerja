# Work Experience Information Page Components

This directory contains ALL components, hooks, utilities, and types for the `/my-info/work?id={id}` page functionality.
...
│   └── EmployeeWork.tsx           # /my-info/work?id={id} page
...
│       ├── EmploymentInfoTab.tsx  # ⭐ Main: Employment information tab
│       ├── WorkExperienceInfoTab.tsx # ⭐ Main: Work experience tab
...
- **Work Experience Management**: View and edit employee work history records
...
```tsx
import { EmployeeWork } from '@/components/1_halaman/2_1_employee/MyInfo/WorkExperience';

// Use in routing
<Route path="/my-info/work" element={<EmployeeWork />} />

// Import specific components
import { WorkExperienceInfoTab, EmployeePageLayout } from '@/components/1_halaman/2_1_employee/MyInfo/WorkExperience';

// Import hooks
import { useWorkExperiences, useEmployeeDetail } from '@/components/1_halaman/2_1_employee/MyInfo/WorkExperience';
```
