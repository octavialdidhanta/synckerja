# Payroll Information Page Components

This directory contains ALL components, hooks, utilities, and types for the `/my-info/payroll?id={id}` page functionality.
...
│   └── EmployeePayroll.tsx        # /my-info/payroll?id={id} page
...
│       ├── PayrollInfoTab.tsx     # ⭐ Main: Payroll information tab
...
- **Payroll Information Management**: View and manage employee payroll data
...
```tsx
import { EmployeePayroll } from '@/components/1_halaman/2_1_employee/MyInfo/Payroll';

// Use in routing
<Route path="/my-info/payroll" element={<EmployeePayroll />} />

// Import specific components
import { PayrollInfoTab, EmployeePageLayout } from '@/components/1_halaman/2_1_employee/MyInfo/Payroll';

// Import hooks
import { useEmployeeDetail, useEmployeePayroll } from '@/components/1_halaman/2_1_employee/MyInfo/Payroll';
```
