# Address Information Page Components

This directory contains ALL components, hooks, utilities, and types for the `/my-info/address?id={id}` page functionality.
...
│   └── EmployeeAddressInfo.tsx    # /my-info/address?id={id} page
...
│       ├── AddressInfoTab.tsx     # ⭐ Main: Address information tab
...
```tsx
import { EmployeeAddressInfo } from '@/components/1_halaman/2_1_employee/MyInfo/AddressInformation';

// Use in routing
<Route path="/my-info/address" element={<EmployeeAddressInfo />} />

// Import specific components
import { AddressInfoTab, EmployeePageLayout } from '@/components/1_halaman/2_1_employee/MyInfo/AddressInformation';

// Import hooks
import { useEmployeeDetail, useUpdateEmployee } from '@/components/1_halaman/2_1_employee/MyInfo/AddressInformation';
```
...
### Pages:
- `src/pages/EmployeeAddressInfo.tsx`
...
- `useUpdateEmployee` - Update employee address data
- `useAutoSave` - Auto-save address changes
