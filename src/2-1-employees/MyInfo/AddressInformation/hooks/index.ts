// Address Information page — shared data hooks live in @/shared/hooks/*
...
export { useCurrentOrg, getCurrentOrganizationId } from '@/2-1-employees/MyInfo/PersonalInformation/hooks/useCurrentOrg';
