# Informal Education Information Page Components

This directory contains ALL components, hooks, utilities, and types for the `/my-info/education/informal?id={id}` page functionality.
...
│   └── EmployeeEducationInformal.tsx # /my-info/education/informal?id={id} page
...
│       ├── InformalEducationInfoTab.tsx # ⭐ Main: Informal education tab
...
- **Informal Education Management**: View and edit employee informal education/training records
...
```tsx
import { EmployeeEducationInformal } from '@/components/1_halaman/2_1_employee/MyInfo/InformalEducation';

// Use in routing
<Route path="/my-info/education/informal" element={<EmployeeEducationInformal />} />

// Import specific components
import { InformalEducationInfoTab, EmployeePageLayout } from '@/components/1_halaman/2_1_employee/MyInfo/InformalEducation';

// Import hooks
import { useInformalEducations, useEmployeeDetail } from '@/components/1_halaman/2_1_employee/MyInfo/InformalEducation';
```
...
### Pages:
- `src/pages/EmployeeEducationInformal.tsx`
