# Family Members Information Page Components

This directory contains ALL components, hooks, utilities, and types for the `/my-info/family?id={id}` page functionality.
...
│   └── EmployeeFamily.tsx         # /my-info/family?id={id} page
...
│       ├── FamilyMembersTab.tsx   # ⭐ Main: Family members tab
...
- **Family Members Management**: View and edit employee family members data
...
```tsx
import { EmployeeFamily } from '@/components/1_halaman/2_1_employee/MyInfo/FamilyMembers';

// Use in routing
<Route path="/my-info/family" element={<EmployeeFamily />} />

// Import specific components
import { FamilyMembersTab, EmployeePageLayout } from '@/components/1_halaman/2_1_employee/MyInfo/FamilyMembers';

// Import hooks
import { useFamilyMembers, useEmployeeDetail } from '@/components/1_halaman/2_1_employee/MyInfo/FamilyMembers';
```
...
- `useAutoSave` - Auto-save family data changes
- `useFamilyMembers` - CRUD operations for family members
