...
/**
 * Mirrors `/okr/department-objective`: scroll shell, HeaderAndTab, grid 9+3,
 * Card + DepartmentObjectivesProgressCard-shaped block + list area, sidebar + footer (same chrome as company tab).
 */
export function DepartmentObjectivePageSkeleton() {
  return (
    <div
      ...
      aria-busy
      aria-label="Loading department objectives"
    >
