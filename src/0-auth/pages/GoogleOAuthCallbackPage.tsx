...
/**
 * OAuth 2.0 redirect target for Google (Drive API, etc.).
 * Exchanges `code` via Edge Function `google-oauth-token` (client secret stays on server).
 */
        ...
        {oauthError ? (
          ...
          <div className="rounded-lg border border-amber-500/30 bg-amber-500/5 p-4 text-sm">
            <p className="font-medium text-amber-900 dark:text-amber-100">
              Tidak ada kode otorisasi di URL
            </p>
            <p className="mt-1 text-muted-foreground">
          ...
          <div className="rounded-lg border border-border bg-muted/40 p-4 text-sm">
            ...
            <p className="mt-2 text-muted-foreground">
              Untuk menyelesaikan penghubungan Google, login ke Synckerja lalu buka kembali tautan ini atau ulangi
              dari pengaturan.
            </p>
