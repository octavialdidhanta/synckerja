...
} from "@/4-2-dashboard/components/AddExpenseForm";
import {
  useExpenses,
          ...
          <div className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden seamless-scroll nested-scroll-touch-chain px-4 py-4 space-y-4">
            ...
            {shareFlowLocked ? (
              <div>
                ...
                {!transactionRefDisplay.trim() && aiAutofillStatus !== "loading" ? (
                  <p className="text-xs text-brand-blue dark:text-brand-blue/90 mt-1">
                    {t(
                ...
                {showAiIdentifierReviewHint ? (
                  <Alert className="mt-2 border-brand-blue/30 bg-brand-blue/10 text-brand-blue dark:border-brand-blue/40 dark:bg-brand-blue/15 dark:text-brand-blue/90">
            ...
            <div>
              <label className="block text-sm font-medium mb-2">
                {t("expenses.expenseName", "Expense Name")} <span className="text-brand-red">*</span>
              </label>
              <Input
            ...
            <div>
              <label className="block text-sm font-medium mb-2">
                {t("expenses.amount", "Amount")} <span className="text-brand-red">*</span>
              </label>
              <Input
                type="text"
