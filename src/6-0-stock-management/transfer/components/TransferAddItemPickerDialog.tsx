...
export function TransferAddItemPickerDialog(props: {
  open: boolean;
      ...
      <DialogContent className="max-w-3xl">
        ...
        <div className="relative">
          ...
          <Input
            ...
            placeholder={
              isProductMode
                ? t("operations.inventory.transfer.searchItems", "Search items")
                : t("operations.inventory.transfer.searchIngredients", "Search ingredients")
            }
            className="pl-8"
          />
        </div>
              ...
              {filtered.length === 0 ? (
                <TableRow>
                  <TableCell colSpan={2} className="text-center text-sm text-muted-foreground">
                    {t("operations.inventory.transfer.noItems", "No items found.")}
                  </TableCell>
                </TableRow>
              ) : isProductMode ? (
