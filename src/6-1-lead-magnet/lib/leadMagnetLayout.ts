...
/** Wrapper card tabel — flex-1 mengisi sisa kolom (tanpa min-h yang memotong footer). */
export const LEAD_MAGNET_TABLE_SECTION = 'flex min-h-0 min-w-0 flex-1 flex-col';
