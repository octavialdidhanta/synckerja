...
/** Layout-matched skeleton for Sales Type route content pane. */
export function SalesTypePageSkeleton() {
  const { t } = useAppTranslation();
  const aria = t("reports.salesType.loadingAria", "Loading sales type report");
