...
import { ReportsHeaderAndTab } from "./ReportsHeaderAndTab";
import { ReportsPageSkeleton } from "../pages/ReportsPageSkeleton";
...
export function ReportsModuleShell({
  children,
  showContent = true,
  loadingSkeleton,
}: Props) {
  const skeleton = loadingSkeleton ?? <ReportsPageSkeleton />;
  return (
