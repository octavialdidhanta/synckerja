...
export function CategorySalesToolbar({
  outletId,
  onOutletChange,
  dateRange,
  onDateRangeChange,
  ...
  return (
    <ReportsSalesToolbarShell
      title={t("reports.categorySales.title", "Category Sales")}
      description={
        <p className="text-sm text-gray-500">
          {t(
            "reports.categorySales.subtitle",
            "Product sales grouped by catalog category for the selected period.",
          )}
        </p>
      }
    >
