...
export function ServedBySalesToolbar({
  outletId,
  onOutletChange,
  dateRange,
  onDateRangeChange,
  ...
  return (
    <ReportsSalesToolbarShell
      title={t("reports.servedBySales.title", "Served By")}
      description={
        <p className="text-sm text-gray-500">
          {t(
            "reports.servedBySales.subtitle",
            "Track gross and net sales per waiter or order taker, with sales type breakdown.",
          )}
        </p>
      }
    >
