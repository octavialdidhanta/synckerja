...
/** Layout-matched skeleton for Modifier Sales route content pane. */
export function ModifierSalesPageSkeleton() {
  const { t } = useAppTranslation();
  const aria = t("reports.modifierSales.loadingAria", "Loading modifier sales report");
...
function cnLabel(i: number): string {
  return i % 3 === 1 ? "h-4 w-36" : "h-4 w-28";
}
