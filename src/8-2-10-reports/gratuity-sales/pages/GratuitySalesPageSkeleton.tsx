...
/** Layout-matched skeleton for Gratuity Sales route content pane. */
export function GratuitySalesPageSkeleton() {
  const { t } = useAppTranslation();
  const aria = t("reports.gratuitySales.loadingAria", "Loading gratuity sales report");
