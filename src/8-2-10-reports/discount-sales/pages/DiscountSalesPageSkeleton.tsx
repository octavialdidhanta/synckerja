...
/** Layout-matched skeleton for Discount Sales route content pane. */
export function DiscountSalesPageSkeleton() {
  const { t } = useAppTranslation();
  const aria = t("reports.discountSales.loadingAria", "Loading discount sales report");
