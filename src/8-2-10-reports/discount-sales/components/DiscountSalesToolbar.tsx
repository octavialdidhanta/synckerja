...
export function DiscountSalesToolbar({
  outletId,
  onOutletChange,
  dateRange,
  onDateRangeChange,
  ...
  return (
    <ReportsSalesToolbarShell
      title={t("reports.discountSales.title", "Discounts")}
      description={
        <p className="text-sm text-gray-500">
          {t(
            "reports.discountSales.subtitle",
            "Track line-item discount usage, frequency, and total revenue impact for the selected period.",
          )}
        </p>
      }
    >
