...
/** Layout-matched skeleton for Tax Sales route content pane. */
export function TaxSalesPageSkeleton() {
  const { t } = useAppTranslation();
  const aria = t("reports.taxSales.loadingAria", "Loading tax sales report");
