...
export function TaxSalesToolbar({
  outletId,
  onOutletChange,
  dateRange,
  onDateRangeChange,
  ...
  return (
    <ReportsSalesToolbarShell
      title={t("reports.taxSales.title", "Taxes")}
      description={
        <p className="text-sm text-gray-500">
          {t(
            "reports.taxSales.subtitle",
            "Track tax collected per rate (PB1, PPN, etc.) for the selected outlet and period.",
          )}
        </p>
      }
    >
