...
/** Layout-matched skeleton for Collected By Sales route content pane. */
export function CollectedBySalesPageSkeleton() {
  const { t } = useAppTranslation();
  const aria = t("reports.collectedBySales.loadingAria", "Loading collected-by report");
