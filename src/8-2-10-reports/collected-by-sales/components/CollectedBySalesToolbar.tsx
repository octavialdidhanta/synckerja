...
export function CollectedBySalesToolbar({
  outletId,
  onOutletChange,
  dateRange,
  onDateRangeChange,
  ...
  return (
    <ReportsSalesToolbarShell
      title={t("reports.collectedBySales.title", "Collected By")}
      description={
        <p className="text-sm text-gray-500">
          {t(
            "reports.collectedBySales.subtitle",
            "Track real money collected per staff who processed payments, with cash and non-cash breakdown.",
          )}
        </p>
      }
    >
