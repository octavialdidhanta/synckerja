...
export function exportItemSoldHourlyXlsx(args: {
  ...
  XLSX.utils.book_append_sheet(wb, XLSX.utils.aoa_to_sheet(rows), "Item Sold Hourly");
  XLSX.writeFile(wb, `item-sold-hourly-${args.fromYmd}_${args.toYmd}.xlsx`);
}
