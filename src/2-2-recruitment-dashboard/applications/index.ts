// HR dashboard (list, filters, quick view)
export { CandidatesTable } from './dashboard/CandidatesTable';
...
export { ApplicationsOverview } from './dashboard/ApplicationsOverview';
