...
export function ApplicationForm({
  ...
  return (
    <div className="flex max-h-[90vh] flex-col overflow-hidden rounded-lg border bg-white shadow-sm">
      {/* Header */}
      ...
      <form onSubmit={handleSubmit} className="flex min-h-0 flex-1 flex-col">
        {/* Scrollable content (hide scrollbar but keep scroll) */}
        <div className="scrollbar-hide seamless-scroll nested-scroll-touch-chain flex-1 overflow-y-auto px-6 py-6 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {/* bottom spacer so last field not hidden behind sticky footer */}
        ...
        <div className="sticky bottom-0 z-10 border-t bg-white px-6 py-4">
          <div className="flex justify-end space-x-4">
            <button
              ...
              onClick={onClose}
              disabled={submitting}
              className="rounded-md border border-gray-300 px-6 py-2 text-gray-700 transition-colors hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-50"
            >
              Cancel
            </button>
            <button
              type="submit"
              disabled={submitting}
              className="flex items-center gap-2 rounded-md bg-blue-600 px-6 py-2 text-white transition-colors hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-50"
            >
              {submitting ? (
                <>
