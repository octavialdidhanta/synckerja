 ...
 * Reference version is larger and depends on additional components/hooks.
 * This preserves the essential contract: show link editor + call `onSave`/`onApprove`/`onRevision`.
 */
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="max-w-xl">
        ...
        {planTitle ? <div className="mb-3 text-sm text-muted-foreground">{planTitle}</div> : null}
