...
export default function VerifyEmailPage() {
  ...
  useEffect(() => {
    ...
    const id = window.setTimeout(() => {
      setSuccessRedirectSeconds((prev) =>
  ...
  const otpDisabled =
    otpSubmitting || resendingEmail || successRedirectSeconds !== null;
        ...
        <div className="flex flex-col items-stretch space-y-6 text-center">
          ...
          <div className="w-full space-y-3">
            <Button
              ...
              disabled={
                resendingEmail || resendCooldown > 0 || otpSubmitting || successRedirectSeconds !== null
              }
            >
              {resendingEmail ? (
                <>
