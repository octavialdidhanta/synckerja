...
import { CustomersPageSkeleton } from "../skeletons/CustomersPageSkeleton";

type CustomersModuleShellProps = {
  children: ReactNode;
  showContent: boolean;
...
export function CustomersModuleShell({
  ...
  showContent,
  loadingSkeleton,
}: CustomersModuleShellProps) {
  const skeleton = loadingSkeleton ?? <CustomersPageSkeleton />;
  return (
