export const SOCIAL_MEDIA_MANAGE_COMMENTS_BASE_PATH =
  "/digital-marketing/social-media-performance/manage-comments";

export const SOCIAL_MEDIA_MANAGE_COMMENTS_TIKTOK_PATH =
  "/digital-marketing/social-media-performance/manage-comments/tiktok";
