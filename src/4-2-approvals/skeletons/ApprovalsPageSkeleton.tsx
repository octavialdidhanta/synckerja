...
import { APPROVALS_MAIN_GRID, APPROVALS_TABLE_CARD } from '@/4-2-approvals/layout/approvalsLayout';

/** Mirror `ApprovalsPage` + Seamless Page Scroll (header ikut scroll, AppShell: `h-full`). */
const MAIN_SCROLL =
...
/** Skeleton khusus `/expenses/approvals` — selaras `ReminderBillsPageSkeleton`. */
