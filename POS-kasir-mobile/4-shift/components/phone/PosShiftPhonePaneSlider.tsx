...
import type { PosShiftPhonePane } from "../../lib/posShiftPhoneLayout";

const SWIPE_THRESHOLD_PX = 56;

type Props = {
  pane: PosShiftPhonePane;
  onPaneChange: (pane: PosShiftPhonePane) => void;
  list: ReactNode;
  detail: ReactNode;
  className?: string;
};
 ...
 */
export function PosShiftPhonePaneSlider({
  pane,
  onPaneChange,
  list,
  detail,
  ...
  // Blur focus before hiding a pane — avoids aria-hidden + focused descendant warnings.
  useEffect(() => {
  ...
  const onPointerDown = useCallback((e: PointerEvent<HTMLDivElement>) => {
    ...
    // Don't hijack taps on back/buttons — Android WebView often drops click after parent pointer tracking.
