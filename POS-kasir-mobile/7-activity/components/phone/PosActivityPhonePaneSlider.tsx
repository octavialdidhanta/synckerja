...
import type { PosActivityPhonePane } from "../../lib/posActivityPhoneLayout";

const SWIPE_THRESHOLD_PX = 56;

type Props = {
  pane: PosActivityPhonePane;
  onPaneChange: (pane: PosActivityPhonePane) => void;
  list: ReactNode;
  detail: ReactNode;
  className?: string;
};
 ...
 */
export function PosActivityPhonePaneSlider({
  pane,
  onPaneChange,
  list,
  detail,
