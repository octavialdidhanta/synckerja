      ...
      >
        <div className="relative flex items-center justify-center border-b border-slate-100 px-3 py-3">
          ...
          <DialogTitle className="text-base font-semibold">
            {t(POS_SPLIT_BILL_I18N.title, "Split Bill")}
          </DialogTitle>
          <Button
            type="button"
            size="sm"
        ...
        <div className="mx-3 mt-3 flex items-center justify-between rounded-lg border border-slate-200 bg-slate-50 px-3 py-2.5">
